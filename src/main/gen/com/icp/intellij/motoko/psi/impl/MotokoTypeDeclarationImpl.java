...
public class MotokoTypeDeclarationImpl extends ASTWrapperPsiElement implements MotokoTypeDeclaration {

  public MotokoTypeDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
