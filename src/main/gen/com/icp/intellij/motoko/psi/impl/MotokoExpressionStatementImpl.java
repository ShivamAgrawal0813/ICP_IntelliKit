...
public class MotokoExpressionStatementImpl extends ASTWrapperPsiElement implements MotokoExpressionStatement {

  public MotokoExpressionStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public MotokoExpression getExpression() {
    return findNotNullChildByClass(MotokoExpression.class);
  }
