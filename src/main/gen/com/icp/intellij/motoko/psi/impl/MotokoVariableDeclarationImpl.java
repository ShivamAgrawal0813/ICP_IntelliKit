...
public class MotokoVariableDeclarationImpl extends ASTWrapperPsiElement implements MotokoVariableDeclaration {

  public MotokoVariableDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public MotokoTypeExpression getTypeExpression() {
    return findChildByClass(MotokoTypeExpression.class);
  }
