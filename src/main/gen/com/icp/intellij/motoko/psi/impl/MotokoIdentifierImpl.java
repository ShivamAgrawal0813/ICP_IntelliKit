...
public class MotokoIdentifierImpl extends ASTWrapperPsiElement implements MotokoIdentifier {

  public MotokoIdentifierImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public MotokoId getId() {
    return findNotNullChildByClass(MotokoId.class);
  }
