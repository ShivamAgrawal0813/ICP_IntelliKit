...
public class MotokoActorDeclarationImpl extends ASTWrapperPsiElement implements MotokoActorDeclaration {

  public MotokoActorDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public MotokoActorBody getActorBody() {
    return findNotNullChildByClass(MotokoActorBody.class);
  }
