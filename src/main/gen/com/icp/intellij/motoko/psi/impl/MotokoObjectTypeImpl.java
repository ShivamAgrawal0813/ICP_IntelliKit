...
public class MotokoObjectTypeImpl extends ASTWrapperPsiElement implements MotokoObjectType {

  public MotokoObjectTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<MotokoFieldType> getFieldTypeList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, MotokoFieldType.class);
  }
