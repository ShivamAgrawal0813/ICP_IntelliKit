...
public class MotokoParser implements PsiParser, LightPsiParser {
  ...
  /* ********************************************************** */
  // expression (plus | minus | star | slash | eq | neq | lt | lte | gt | gte) expression
  public static boolean binary_expression(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && binary_expression_1(builder_, level_ + 1);
  ...
  public static boolean call_expression(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeTokens(builder_, 0, ID, LPAREN);
    result_ = result_ && call_expression_2(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, RPAREN);
    exit_section_(builder_, marker_, CALL_EXPRESSION, result_);
    return result_;
  }
  ...
  /* ********************************************************** */
  // binary_expression | call_expression | literal | id
  ...
  public static boolean function_body(PsiBuilder builder_, int level_) {
    ...
    while (true) {
      ...
      if (!empty_element_parsed_guard_(builder_, "function_body", pos_)) break;
    }
    exit_section_(builder_, level_, marker_, true, false, null);
    return true;
  }
  ...
  /* ********************************************************** */
  // func id lparen parameter_list? rparen colon type_expression lbrace function_body rbrace
  public static boolean function_declaration(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeTokens(builder_, 0, FUNC, ID, LPAREN);
    result_ = result_ && function_declaration_3(builder_, level_ + 1);
  ...
  private static boolean if_statement_5_0(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeTokens(builder_, 0, ELSE, LBRACE);
    result_ = result_ && if_statement_5_0_2(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, RBRACE);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // statement*
  private static boolean if_statement_5_0_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "if_statement_5_0_2")) return false;
    while (true) {
      int pos_ = current_position_(builder_);
      if (!statement(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "if_statement_5_0_2", pos_)) break;
    }
    return true;
  }
  ...
  public static boolean loop_statement(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeTokens(builder_, 0, LOOP, LBRACE);
    result_ = result_ && loop_statement_2(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, RBRACE);
  ...
  // statement*
  private static boolean loop_statement_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "loop_statement_2")) return false;
    while (true) {
      int pos_ = current_position_(builder_);
      if (!statement(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "loop_statement_2", pos_)) break;
    }
    return true;
  }
  ...
  /* ********************************************************** */
  // expression_statement | return_statement | if_statement | loop_statement
  ...
  public static boolean type_declaration(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && type_expression(builder_, level_ + 1);
    result_ = result_ && type_declaration_4(builder_, level_ + 1);
    exit_section_(builder_, marker_, TYPE_DECLARATION, result_);
    return result_;
  }

  // semicolon?
  private static boolean type_declaration_4(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "type_declaration_4")) return false;
    consumeToken(builder_, SEMICOLON);
    return true;
  }

  /* ********************************************************** */
  // primitive_type | function_type | object_type | array_type | type_reference
  ...
  public static boolean variable_declaration(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && variable_declaration_4(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
    return result_;
  }
  ...
  private static boolean variable_declaration_3(PsiBuilder builder_, int level_) {
    ...
    variable_declaration_3_0(builder_, level_ + 1);
    return true;
  }

  // eq expression
  private static boolean variable_declaration_3_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "variable_declaration_3_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
  ...
  // semicolon?
  private static boolean variable_declaration_4(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "variable_declaration_4")) return false;
    consumeToken(builder_, SEMICOLON);
    return true;
  }
