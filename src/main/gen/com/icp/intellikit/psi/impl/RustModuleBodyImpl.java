...
public class RustModuleBodyImpl extends ASTWrapperPsiElement implements RustModuleBody {
  ...
  @Override
  @NotNull
  public List<RustModuleDeclaration> getModuleDeclarationList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, RustModuleDeclaration.class);
  }
  ...
  @Override
  @NotNull
  public List<RustTraitDeclaration> getTraitDeclarationList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, RustTraitDeclaration.class);
  }

  @Override
  @NotNull
  public List<RustTypeDeclaration> getTypeDeclarationList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, RustTypeDeclaration.class);
  }
