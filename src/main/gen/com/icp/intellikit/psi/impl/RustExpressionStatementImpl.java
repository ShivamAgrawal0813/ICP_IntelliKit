...
public class RustExpressionStatementImpl extends ASTWrapperPsiElement implements RustExpressionStatement {

  public RustExpressionStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
