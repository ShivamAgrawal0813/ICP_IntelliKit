...
public class RustMethodCallExpressionImpl extends ASTWrapperPsiElement implements RustMethodCallExpression {

  public RustMethodCallExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
