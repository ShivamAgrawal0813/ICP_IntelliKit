...
public class RustFieldInitializerImpl extends ASTWrapperPsiElement implements RustFieldInitializer {

  public RustFieldInitializerImpl(@NotNull ASTNode node) {
    super(node);
  }
